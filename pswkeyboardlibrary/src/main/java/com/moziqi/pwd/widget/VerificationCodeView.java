...
public class VerificationCodeView extends LinearLayout implements TextWatcher, View.OnKeyListener, View.OnFocusChangeListener {
    ...
    public VerificationCodeView(Context context, AttributeSet attrs) {
        ...
        mEtTextBg = typedArray.getResourceId(R.styleable.vericationCodeView_vcv_et_bg, R.drawable.pwd_et_login_code);
        mCursorDrawable = typedArray.getResourceId(R.styleable.vericationCodeView_vcv_et_cursor, R.drawable.pwd_et_cursor);
    ...
    private void initEditText(ZanyEditText editText, int i) {
        ...
        Drawable drawable = getResources().getDrawable(mEtTextBg);
